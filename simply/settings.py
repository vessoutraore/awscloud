...
SECRET_KEY = 'django-insecure-fg$j%47k(7xsmo30tgl0=7^ocs%mi++)khi$#agx@+=70*j&o$'
...
# Spécifiez la région AWS explicitement
AWS_S3_REGION_NAME = "us-east-1"
AWS_STORAGES_BUCKET_NAME = "dss-demo-bucket-ufg"
